    ...
    public partial class Transaction : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Destination = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: true),
                    ...
                    CreditPurchaseId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_CreditPurchases_CreditPurchaseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_CreditPurchaseId",
                table: "Transactions",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CreditExpenses", x => x.Id);
                    table.ForeignKey(
