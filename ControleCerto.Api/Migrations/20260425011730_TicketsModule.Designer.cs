...
namespace ControleCerto.Migrations
{
    ...
    [Migration("20260425011730_TicketsModule")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ControleCerto.Models.Entities.Article", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ControleCerto.Models.Entities.Investment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ControleCerto.Models.Entities.InvestmentHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ControleCerto.Models.Entities.Note", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ControleCerto.Models.Entities.Notification", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ControleCerto.Models.Entities.RecurrenceRule", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<int?>("DayOfMonthForYearly")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("MonthOfYear");

                    b.ToTable("RecurrenceRules", (string)null);
                });

            modelBuilder.Entity("ControleCerto.Models.Entities.RecurringTransaction", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ControleCerto.Models.Entities.RecurringTransactionInstance", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("ActualTransactionId")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("RecurringTransactionInstances", (string)null);
                });

            modelBuilder.Entity("ControleCerto.Models.Entities.Ticket", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ControleCerto.Models.Entities.TicketAttachment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("TicketMessageId", "CreatedAt");

                    b.ToTable("TicketAttachments");
                });

            modelBuilder.Entity("ControleCerto.Models.Entities.TicketMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ControleCerto.Models.Entities.Category", b =>
                {
                    b.HasOne("ControleCerto.Models.Entities.Category", "Parent")
                        .WithMany()
            ...
            modelBuilder.Entity("ControleCerto.Models.Entities.InvestmentHistory", b =>
                {
                    b.HasOne("ControleCerto.Models.Entities.Investment", "Investment")
                        .WithMany("Histories")
            ...
            modelBuilder.Entity("ControleCerto.Models.Entities.RecurringTransaction", b =>
                {
                    ...
                    b.HasOne("ControleCerto.Models.Entities.RecurrenceRule", "RecurrenceRule")
            ...
            modelBuilder.Entity("ControleCerto.Models.Entities.RecurringTransactionInstance", b =>
                {
                    b.HasOne("ControleCerto.Models.Entities.Transaction", "ActualTransaction")
                        .WithMany()
                        .HasForeignKey("ActualTransactionId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("ControleCerto.Models.Entities.RecurringTransaction", "RecurringTransaction")
                        .WithMany("Instances")
            ...
            modelBuilder.Entity("ControleCerto.Models.Entities.TicketAttachment", b =>
                {
                    b.HasOne("ControleCerto.Models.Entities.Ticket", "Ticket")
                        .WithMany("Attachments")
                        .HasForeignKey("TicketId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ControleCerto.Models.Entities.TicketMessage", "TicketMessage")
                        .WithMany("Attachments")
                        .HasForeignKey("TicketMessageId");

                    b.HasOne("ControleCerto.Models.Entities.User", "UploadedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("ControleCerto.Models.Entities.TicketMessage", b =>
                {
                    b.HasOne("ControleCerto.Models.Entities.User", "AuthorUser")
                        .WithMany()
